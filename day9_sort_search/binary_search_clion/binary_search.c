...
int main()
{
	...
	printf("Time taken for \tprintf(\"Time taken for binary search with 1,000,000,000 elements, 100,000 times %f sec\\n\", duration);binary search with 1,000,000,000 elements, 100,000 times %f sec\n", duration);
